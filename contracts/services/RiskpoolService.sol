    ...
    CoreController
{
     ...
     * @return fee The fee charged for processing the capital.
     * @return netCapital The net capital after deducting the fee.
     */
     ...
     * @return feeAmount The amount of fees paid to the treasury during the withdrawal process.
     * @return netAmount The net amount withdrawn from the bundle's balance after fees.
     */
