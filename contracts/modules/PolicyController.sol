    ...
    CoreController
{
     ...
     * @return application.createdAt The timestamp when the application was created.
     * @return application.data The application data.
     */
     ...
     * @return policy.createdAt The timestamp when the policy was created.
     * @return policy.expiration The timestamp when the policy will expire.
     * @return policy.premium The amount of premium paid for the policy.
     * @return policy.coverage The amount of coverage provided by the policy.
     * @return policy.beneficiary The address of the beneficiary of the policy.
     * @return policy.claimedAmount The amount claimed from the policy so far.
     * @return policy.claimedAt The timestamp when the last claim was made from the policy.
     * @return policy.status The status of the policy (active, expired, or cancelled).
     * @return policy.payouts The total amount paid out from the policy so far.
     * @return policy.claimCount The number of claims made from the policy so far.
     * @return policy.maxClaimAmount The maximum amount that can be claimed from the policy.
     * @return policy.claimPeriod The time period during which claims can be made from the policy.
     * @return policy.claimApprovalDelay The delay before a claim is approved by the insurer.
     * @return policy.claimDenialReason The reason for denying a claim.
     * @return policy.claimApprovalReason The reason for approving a claim.
     * @return policy.claimPayoutReason The reason for paying out a claim.
     * @return policy.claimRejectionReason The reason for rejecting a claim.
     * @return policy.claimAppealReason The reason for appealing a claim.
     * @return policy.claimAppealApprovalReason The reason for approving an appealed claim.
     * @return policy.claimAppealDenialReason The reason for denying an appealed claim.
     * @return policy.claimAppealPayoutReason The reason for paying out an appealed claim.
     * @return policy.claimAppealRejectionReason The reason for rejecting an appealed claim.
     * @return policy.claimAppealStatus The status of an appealed claim.
     * @return policy.claimAppealCreatedAt The timestamp when an appeal was made for a claim.
     * @return policy.claimAppealApprovedAt The timestamp when an appealed claim was approved.
     * @return policy.claimAppealDeniedAt The timestamp when an appealed claim was denied.
     * @return policy.claimAppealPaidAt The timestamp when an appealed claim was paid.
     * @return policy.claimAppealRejectedAt The timestamp when an appealed claim was rejected.
     * @return policy.claimAppealReasonUpdatedAt The timestamp when the reason for appealing a claim was updated.
     * @return policy.claimAppealStatusUpdatedAt The timestamp when the status of an appealed claim was updated.
     */
