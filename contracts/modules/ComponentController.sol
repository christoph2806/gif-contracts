...
contract ComponentController is
    ...
    CoreController 
 {
     ...
     * @revert "ERROR:CCR-005:INVALID_COMPONENT_ID" if the component with the given ID doesn't exist.
     */
     ...
     * @revert "ERROR:CCR-006:COMPONENT_ADDRESS_ZERO" If the component address is zero.
     * @revert "ERROR:CCR-007:COMPONENT_UNKNOWN" If the component is not registered.
     */
     ...
     * @return oldState The previous state of the component.
     *
