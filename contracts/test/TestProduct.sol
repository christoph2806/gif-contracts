    ...
    Product 
{
     ...
     * @return success A boolean indicating whether the underwriting was successful or not.
     */
     ...
     * @return isLossEvent A boolean value indicating if the event is a loss event.
     *
