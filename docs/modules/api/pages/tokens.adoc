...
[.contract-subindex-inherited]
.ERC721
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-supportsInterface-bytes4-[`++supportsInterface(interfaceId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-balanceOf-address-[`++balanceOf(owner)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-ownerOf-uint256-[`++ownerOf(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-name--[`++name()++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-symbol--[`++symbol()++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-tokenURI-uint256-[`++tokenURI(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_baseURI--[`++_baseURI()++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-approve-address-uint256-[`++approve(to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-getApproved-uint256-[`++getApproved(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-setApprovalForAll-address-bool-[`++setApprovalForAll(operator, approved)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-isApprovedForAll-address-address-[`++isApprovedForAll(owner, operator)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-transferFrom-address-address-uint256-[`++transferFrom(from, to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-safeTransferFrom-address-address-uint256-[`++safeTransferFrom(from, to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-safeTransferFrom-address-address-uint256-bytes-[`++safeTransferFrom(from, to, tokenId, data)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_safeTransfer-address-address-uint256-bytes-[`++_safeTransfer(from, to, tokenId, data)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_exists-uint256-[`++_exists(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_isApprovedOrOwner-address-uint256-[`++_isApprovedOrOwner(spender, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_safeMint-address-uint256-[`++_safeMint(to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_safeMint-address-uint256-bytes-[`++_safeMint(to, tokenId, data)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_mint-address-uint256-[`++_mint(to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_burn-uint256-[`++_burn(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_transfer-address-address-uint256-[`++_transfer(from, to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_approve-address-uint256-[`++_approve(to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_setApprovalForAll-address-address-bool-[`++_setApprovalForAll(owner, operator, approved)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_requireMinted-uint256-[`++_requireMinted(tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_beforeTokenTransfer-address-address-uint256-[`++_beforeTokenTransfer(from, to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#ERC721-_afterTokenTransfer-address-address-uint256-[`++_afterTokenTransfer(from, to, tokenId)++`]
...
[.contract-subindex-inherited]
.IERC721
* https://docs.openzeppelin.com/contracts/4.x/api/token#IERC721-Transfer-address-address-uint256-[`++Transfer(from, to, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#IERC721-Approval-address-address-uint256-[`++Approval(owner, approved, tokenId)++`]
* https://docs.openzeppelin.com/contracts/4.x/api/token#IERC721-ApprovalForAll-address-address-bool-[`++ApprovalForAll(owner, operator, approved)++`]
