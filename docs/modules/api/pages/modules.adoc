...
[.contract]
[[AccessController]]
=== `++AccessController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/AccessController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/AccessController.sol";
```
...
[.contract]
[[BundleController]]
=== `++BundleController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/BundleController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/BundleController.sol";
```
...
[.contract-subindex-inherited]
.IBundle
* {xref-IBundle-LogBundleCreated-uint256-uint256-address-enum-IBundle-BundleState-uint256-}[`++LogBundleCreated(bundleId, riskpoolId, owner, state, amount)++`]
* {xref-IBundle-LogBundleStateChanged-uint256-enum-IBundle-BundleState-enum-IBundle-BundleState-}[`++LogBundleStateChanged(bundleId, oldState, newState)++`]
* {xref-IBundle-LogBundleCapitalProvided-uint256-address-uint256-uint256-}[`++LogBundleCapitalProvided(bundleId, sender, amount, capacity)++`]
* {xref-IBundle-LogBundleCapitalWithdrawn-uint256-address-uint256-uint256-}[`++LogBundleCapitalWithdrawn(bundleId, recipient, amount, capacity)++`]
* {xref-IBundle-LogBundlePolicyCollateralized-uint256-bytes32-uint256-uint256-}[`++LogBundlePolicyCollateralized(bundleId, processId, amount, capacity)++`]
* {xref-IBundle-LogBundlePayoutProcessed-uint256-bytes32-uint256-}[`++LogBundlePayoutProcessed(bundleId, processId, amount)++`]
* {xref-IBundle-LogBundlePolicyReleased-uint256-bytes32-uint256-uint256-}[`++LogBundlePolicyReleased(bundleId, processId, amount, capacity)++`]
...
[.contract]
[[ComponentController]]
=== `++ComponentController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/ComponentController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/ComponentController.sol";
```
...
[.contract]
[[LicenseController]]
=== `++LicenseController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/LicenseController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/LicenseController.sol";
```
...
[.contract]
[[PolicyController]]
=== `++PolicyController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/PolicyController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/PolicyController.sol";
```
...
[.contract-subindex-inherited]
.IPolicy
* {xref-IPolicy-LogMetadataCreated-address-bytes32-uint256-enum-IPolicy-PolicyFlowState-}[`++LogMetadataCreated(owner, processId, productId, state)++`]
* {xref-IPolicy-LogMetadataStateChanged-bytes32-enum-IPolicy-PolicyFlowState-}[`++LogMetadataStateChanged(processId, state)++`]
* {xref-IPolicy-LogApplicationCreated-bytes32-uint256-uint256-}[`++LogApplicationCreated(processId, premiumAmount, sumInsuredAmount)++`]
* {xref-IPolicy-LogApplicationRevoked-bytes32-}[`++LogApplicationRevoked(processId)++`]
* {xref-IPolicy-LogApplicationUnderwritten-bytes32-}[`++LogApplicationUnderwritten(processId)++`]
* {xref-IPolicy-LogApplicationDeclined-bytes32-}[`++LogApplicationDeclined(processId)++`]
* {xref-IPolicy-LogPolicyCreated-bytes32-}[`++LogPolicyCreated(processId)++`]
* {xref-IPolicy-LogPolicyExpired-bytes32-}[`++LogPolicyExpired(processId)++`]
* {xref-IPolicy-LogPolicyClosed-bytes32-}[`++LogPolicyClosed(processId)++`]
* {xref-IPolicy-LogPremiumCollected-bytes32-uint256-}[`++LogPremiumCollected(processId, amount)++`]
* {xref-IPolicy-LogApplicationSumInsuredAdjusted-bytes32-uint256-uint256-}[`++LogApplicationSumInsuredAdjusted(processId, sumInsuredAmountOld, sumInsuredAmount)++`]
* {xref-IPolicy-LogApplicationPremiumAdjusted-bytes32-uint256-uint256-}[`++LogApplicationPremiumAdjusted(processId, premiumAmountOld, premiumAmount)++`]
* {xref-IPolicy-LogPolicyPremiumAdjusted-bytes32-uint256-uint256-}[`++LogPolicyPremiumAdjusted(processId, premiumExpectedAmountOld, premiumExpectedAmount)++`]
* {xref-IPolicy-LogClaimCreated-bytes32-uint256-uint256-}[`++LogClaimCreated(processId, claimId, claimAmount)++`]
* {xref-IPolicy-LogClaimConfirmed-bytes32-uint256-uint256-}[`++LogClaimConfirmed(processId, claimId, confirmedAmount)++`]
* {xref-IPolicy-LogClaimDeclined-bytes32-uint256-}[`++LogClaimDeclined(processId, claimId)++`]
* {xref-IPolicy-LogClaimClosed-bytes32-uint256-}[`++LogClaimClosed(processId, claimId)++`]
* {xref-IPolicy-LogPayoutCreated-bytes32-uint256-uint256-uint256-}[`++LogPayoutCreated(processId, claimId, payoutId, amount)++`]
* {xref-IPolicy-LogPayoutProcessed-bytes32-uint256-}[`++LogPayoutProcessed(processId, payoutId)++`]
...
[.contract]
[[PoolController]]
=== `++PoolController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/PoolController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/PoolController.sol";
```
...
[.contract-subindex-inherited]
.IPool
* {xref-IPool-LogRiskpoolRegistered-uint256-address-address-uint256-uint256-}[`++LogRiskpoolRegistered(riskpoolId, wallet, erc20Token, collateralizationLevel, sumOfSumInsuredCap)++`]
* {xref-IPool-LogRiskpoolRequiredCollateral-bytes32-uint256-uint256-}[`++LogRiskpoolRequiredCollateral(processId, sumInsured, collateral)++`]
* {xref-IPool-LogRiskpoolCollateralizationFailed-uint256-bytes32-uint256-}[`++LogRiskpoolCollateralizationFailed(riskpoolId, processId, amount)++`]
* {xref-IPool-LogRiskpoolCollateralizationSucceeded-uint256-bytes32-uint256-}[`++LogRiskpoolCollateralizationSucceeded(riskpoolId, processId, amount)++`]
* {xref-IPool-LogRiskpoolCollateralReleased-uint256-bytes32-uint256-}[`++LogRiskpoolCollateralReleased(riskpoolId, processId, amount)++`]
...
[.contract]
[[QueryModule]]
=== `++QueryModule++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/QueryModule.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/QueryModule.sol";
```
...
[.contract-subindex-inherited]
.IQuery
* {xref-IQuery-LogOracleRequested-bytes32-uint256-uint256-}[`++LogOracleRequested(processId, requestId, responsibleOracleId)++`]
* {xref-IQuery-LogOracleResponded-bytes32-uint256-address-bool-}[`++LogOracleResponded(processId, requestId, responder, success)++`]
* {xref-IQuery-LogOracleCanceled-uint256-}[`++LogOracleCanceled(requestId)++`]
...
[.contract]
[[RegistryController]]
=== `++RegistryController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/RegistryController.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/RegistryController.sol";
```
...
[.contract]
[[TreasuryModule]]
=== `++TreasuryModule++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.0.0-rc.1-0/contracts/modules/TreasuryModule.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "@openzeppelin/contracts/modules/TreasuryModule.sol";
```
...
[.contract-subindex-inherited]
.ITreasury
* {xref-ITreasury-LogTreasurySuspended--}[`++LogTreasurySuspended()++`]
* {xref-ITreasury-LogTreasuryResumed--}[`++LogTreasuryResumed()++`]
* {xref-ITreasury-LogTreasuryProductTokenSet-uint256-uint256-address-}[`++LogTreasuryProductTokenSet(productId, riskpoolId, erc20Address)++`]
* {xref-ITreasury-LogTreasuryInstanceWalletSet-address-}[`++LogTreasuryInstanceWalletSet(walletAddress)++`]
* {xref-ITreasury-LogTreasuryRiskpoolWalletSet-uint256-address-}[`++LogTreasuryRiskpoolWalletSet(riskpoolId, walletAddress)++`]
* {xref-ITreasury-LogTreasuryPremiumFeesSet-uint256-uint256-uint256-}[`++LogTreasuryPremiumFeesSet(productId, fixedFee, fractionalFee)++`]
* {xref-ITreasury-LogTreasuryCapitalFeesSet-uint256-uint256-uint256-}[`++LogTreasuryCapitalFeesSet(riskpoolId, fixedFee, fractionalFee)++`]
* {xref-ITreasury-LogTreasuryPremiumTransferred-address-address-uint256-}[`++LogTreasuryPremiumTransferred(from, riskpoolWalletAddress, amount)++`]
* {xref-ITreasury-LogTreasuryPayoutTransferred-address-address-uint256-}[`++LogTreasuryPayoutTransferred(riskpoolWalletAddress, to, amount)++`]
* {xref-ITreasury-LogTreasuryCapitalTransferred-address-address-uint256-}[`++LogTreasuryCapitalTransferred(from, riskpoolWalletAddress, amount)++`]
* {xref-ITreasury-LogTreasuryFeesTransferred-address-address-uint256-}[`++LogTreasuryFeesTransferred(from, instanceWalletAddress, amount)++`]
* {xref-ITreasury-LogTreasuryWithdrawalTransferred-address-address-uint256-}[`++LogTreasuryWithdrawalTransferred(riskpoolWalletAddress, to, amount)++`]
* {xref-ITreasury-LogTreasuryPremiumProcessed-bytes32-uint256-}[`++LogTreasuryPremiumProcessed(processId, amount)++`]
* {xref-ITreasury-LogTreasuryPayoutProcessed-uint256-address-uint256-}[`++LogTreasuryPayoutProcessed(riskpoolId, to, amount)++`]
* {xref-ITreasury-LogTreasuryCapitalProcessed-uint256-uint256-uint256-}[`++LogTreasuryCapitalProcessed(riskpoolId, bundleId, amount)++`]
* {xref-ITreasury-LogTreasuryWithdrawalProcessed-uint256-uint256-uint256-}[`++LogTreasuryWithdrawalProcessed(riskpoolId, bundleId, amount)++`]
